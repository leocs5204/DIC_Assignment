...
# Get a list of image files in folder images
image_files = [file for file in os.listdir(folder_path) if file.endswith(('.jpg', '.png', '.jpeg'))]

# Choose any file from the list (here, we pick the first file)
...
newImg.save('./images/resized.jpg')
